...
| 192 B – 24 KiB | 9–17 GiB/s | NEON PMULL 折叠（Intel PCLMULQDQ 算法移植） |
| ≥ 24 KiB | ~22 GiB/s | 硬件 CRC32 4 路交错 |

- 多线程（rayon，> 1 MiB）：1MB ~30 GiB/s，10MB ~54 GiB/s，100MB ~43 GiB/s
- 对比 crc32fast：单线程 2–4×，多线程 3–6×
